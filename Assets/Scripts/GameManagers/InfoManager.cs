...
public class InfoManager : MonoBehaviour {
    ...
    void Start() {
        ...
        totalCompleted.text = "Total: " + (casualReached + challengeReached + _8x8Reached + _8x8ChallengeReached) + "/" + (standardTotalLevels*2 + 120);
        ...
        _8x8Completed[0].text = ((float) _8x8Reached / 60) * 100 + "%";
        _8x8Completed[1].text = _8x8Reached + "/" + 60;
        _8x8ChallengeCompleted[0].text = ((float) _8x8ChallengeReached / 60) * 100 + "%";
        _8x8ChallengeCompleted[1].text = _8x8ChallengeReached + "/" + 60;
    }
}
